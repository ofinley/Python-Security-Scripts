# ofinley
# Used in packet sniffer script & other scripts in my python CEH scripts
import scoket
...
class EthernetFrame:
    length = 14 # Length of segment
    def __init__(self, data):
        unpack_data = unpack('!6s6sH', data[0:self.length])
        self.protocol = socket.ntohs(unpacked_data[2])
        self.destination = mac_addr(data[0:6])
        self.source = mac_addr[6:12]
